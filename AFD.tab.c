...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_A = 3,                          /* A  */
  YYSYMBOL_B = 4,                          /* B  */
  YYSYMBOL_FIN_CADENA = 5,                 /* FIN_CADENA  */
  YYSYMBOL_YYACCEPT = 6,                   /* $accept  */
  YYSYMBOL_cadenas = 7,                    /* cadenas  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "A", "B", "FIN_CADENA",
  "$accept", "cadenas", "cadena", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* cadenas: cadenas cadena FIN_CADENA  */
#line 38 "AFD.y"
                                {
        char estado[10];
...
#line 1102 "AFD.tab.c"
  ...
  case 4: /* cadena: A  */
#line 59 "AFD.y"
        { cadena[idx++] = 'a'; cadena[idx] = '\0'; }
#line 1108 "AFD.tab.c"
    break;

  case 5: /* cadena: B  */
#line 60 "AFD.y"
        { cadena[idx++] = 'b'; cadena[idx] = '\0'; }
#line 1114 "AFD.tab.c"
    break;

  case 6: /* cadena: cadena A  */
#line 61 "AFD.y"
               { cadena[idx++] = 'a'; cadena[idx] = '\0'; }
#line 1120 "AFD.tab.c"
    break;

  case 7: /* cadena: cadena B  */
#line 62 "AFD.y"
               { cadena[idx++] = 'b'; cadena[idx] = '\0'; }
#line 1126 "AFD.tab.c"
    break;
